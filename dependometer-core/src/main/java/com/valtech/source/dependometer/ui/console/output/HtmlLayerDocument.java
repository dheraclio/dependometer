 ...
 */
final class HtmlLayerDocument extends HtmlDependencyElementDocument
{
   protected HtmlLayerDocument(File directory, DependencyElementIf element, String metricDescriptionsDocumentName)
   {
