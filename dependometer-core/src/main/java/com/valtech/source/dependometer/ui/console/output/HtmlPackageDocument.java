 ...
 */
final class HtmlPackageDocument extends HtmlDependencyElementDocument
{
   protected HtmlPackageDocument(File directory, DependencyElementIf element, String metricDescriptionsDocumentName)
   {
