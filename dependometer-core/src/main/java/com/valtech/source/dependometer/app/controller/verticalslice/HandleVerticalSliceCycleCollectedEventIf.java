...
public interface HandleVerticalSliceCycleCollectedEventIf
{
   public void handleEvent(
      com.valtech.source.dependometer.app.controller.verticalslice.VerticalSliceCycleCollectedEvent event);
}
