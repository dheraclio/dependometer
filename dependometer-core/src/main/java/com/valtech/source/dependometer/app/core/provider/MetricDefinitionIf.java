 ...
 */
public abstract interface MetricDefinitionIf
{
   public final String TYPE_NUMBER = "number";

   public final String TYPE_TEXT = "text";

   public final String INDEX_NONE = "none";

   public final String INDEX = "index";

   public final String INDEX_ASCENDING = "ascending";

   public final String INDEX_DESCENDING = "descending";
