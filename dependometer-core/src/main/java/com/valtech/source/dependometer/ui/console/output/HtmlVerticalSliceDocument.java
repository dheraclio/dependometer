 ...
 */
final class HtmlVerticalSliceDocument extends HtmlDependencyElementDocument
{
   protected HtmlVerticalSliceDocument(File directory, DependencyElementIf element,
      String metricDescriptionsDocumentName)
   {
      super(directory, element, metricDescriptionsDocumentName);
   }

   protected String getBelongsToTypeName()
   {
      return null;
   }
   ...
   protected String getContainedElementName(DependencyElementIf contained)
   {
      ...
      return contained.getFullyQualifiedName();
   }
