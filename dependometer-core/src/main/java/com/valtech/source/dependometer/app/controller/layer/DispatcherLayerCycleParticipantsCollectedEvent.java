...
final class DispatcherLayerCycleParticipantsCollectedEvent extends Dispatcher
{
   protected void dispatch(Object handler, EventIf event)
   {
      assert handler != null;
      assert event != null;
      ((HandleLayerCycleParticipantsCollectedEventIf)handler)
         .handleEvent((com.valtech.source.dependometer.app.controller.layer.LayerCycleParticipantsCollectedEvent)event);
   }
}
