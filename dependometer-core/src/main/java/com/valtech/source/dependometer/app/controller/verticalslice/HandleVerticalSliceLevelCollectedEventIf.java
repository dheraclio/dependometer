...
public interface HandleVerticalSliceLevelCollectedEventIf
{
   public void handleEvent(
      com.valtech.source.dependometer.app.controller.verticalslice.VerticalSliceLevelCollectedEvent event);
}
