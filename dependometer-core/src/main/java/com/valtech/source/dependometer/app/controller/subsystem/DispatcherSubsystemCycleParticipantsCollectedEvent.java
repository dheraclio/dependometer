...
final class DispatcherSubsystemCycleParticipantsCollectedEvent extends Dispatcher
{
   protected void dispatch(Object handler, EventIf event)
   {
      assert handler != null;
      assert event != null;
      ((HandleSubsystemCycleParticipantsCollectedEventIf)handler)
         .handleEvent((com.valtech.source.dependometer.app.controller.subsystem.SubsystemCycleParticipantsCollectedEvent)event);
   }
}
