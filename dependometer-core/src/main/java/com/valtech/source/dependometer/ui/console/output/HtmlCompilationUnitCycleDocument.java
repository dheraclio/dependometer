 ...
 */
final class HtmlCompilationUnitCycleDocument extends HtmlCycleDocument
{
   protected HtmlCompilationUnitCycleDocument(File directory, String typeName, boolean tangleDoc) throws IOException
   {
