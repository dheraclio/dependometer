...
final class DispatcherLayerCycleParticipationCollectedEvent extends Dispatcher
{
   protected void dispatch(Object handler, EventIf event)
   {
      assert handler != null;
      assert event != null;
      ((HandleLayerCycleParticipationCollectedEventIf)handler)
         .handleEvent((com.valtech.source.dependometer.app.controller.layer.LayerCycleParticipationCollectedEvent)event);
   }
}
