...
final class DispatcherCompilationUnitCycleParticipationCollectedEvent extends Dispatcher
{
   protected void dispatch(Object handler, EventIf event)
   {
      assert handler != null;
      assert event != null;
      ((HandleCompilationUnitCycleParticipationCollectedEventIf)handler)
         .handleEvent((com.valtech.source.dependometer.app.controller.compilationunit.CompilationUnitCycleParticipationCollectedEvent)event);
   }
}
