...
final class DispatcherCompilationUnitCycleParticipantsCollectedEvent extends Dispatcher
{
   protected void dispatch(Object handler, EventIf event)
   {
      assert handler != null;
      assert event != null;
      ((HandleCompilationUnitCycleParticipantsCollectedEventIf)handler)
         .handleEvent((com.valtech.source.dependometer.app.controller.compilationunit.CompilationUnitCycleParticipantsCollectedEvent)event);
   }
}
