...
final class DispatcherTypeCycleParticipantsCollectedEvent extends Dispatcher
{
   protected void dispatch(Object handler, EventIf event)
   {
      assert handler != null;
      assert event != null;
      ((HandleTypeCycleParticipantsCollectedEventIf)handler)
         .handleEvent((com.valtech.source.dependometer.app.controller.type.TypeCycleParticipantsCollectedEvent)event);
   }
}
