...
final class DispatcherVerticalSliceCycleParticipantsCollectedEvent extends Dispatcher
{
   protected void dispatch(Object handler, EventIf event)
   {
      assert handler != null;
      assert event != null;
      ((HandleVerticalSliceCycleParticipantsCollectedEventIf)handler)
         .handleEvent((com.valtech.source.dependometer.app.controller.verticalslice.VerticalSliceCycleParticipantsCollectedEvent)event);
   }
}
